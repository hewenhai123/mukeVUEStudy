   ...
   <div class="index-wrap">
      ...
      <div>
        <div class="list-content">
          <div class="index-board-item" v-for="(item,index) in boardList" :class="[{'index-last':index %2 !==0},'index-board-']+item.id"> 
            <div class="index-board-item-inner"> 
               <h2>{{item.title}}</h2>
               <p>{{item.description}}</p>
               <div>
                <router-link :to="{path:'/detail'+ item.tokey}" class="buttom" >点击购买</router-link>
                 </div>
             </div>
           </div>
         </div>
